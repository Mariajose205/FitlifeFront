...
public class NotificacionController {
    ...
    public ResponseEntity<String> enviarEventoPagoPrueba(@RequestBody PagoEventDTO pagoEvent) {
        try {
            ...
            return new ResponseEntity<>("Evento de pago enviado correctamente: " + pagoEvent.getTipoEvento(), HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<>("Error enviando evento: " + e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
