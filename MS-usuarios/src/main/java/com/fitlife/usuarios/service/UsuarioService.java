...
public class UsuarioService {
    ...
    public Optional<Usuario> obtenerUsuarioPorEmail(@NonNull String email) {
        return usuarioRepository.findByEmail(email);
    }

    public Usuario crearUsuario(Usuario usuario) {
        // Guardar contraseña temporalmente (sin encriptar hasta que Spring Security esté disponible)
    ...
    public boolean authenticateUser(String email, String password) {
        ...
        // Comparación simple temporal (sin encriptar hasta que Spring Security esté disponible)
