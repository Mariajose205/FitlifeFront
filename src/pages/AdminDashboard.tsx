    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-3">
          {[
            { name: 'Reporte Mensual de Ingresos', date: '2026-04-30', type: 'PDF' },
            { name: 'Análisis de Membresías', date: '2026-04-28', type: 'Excel' },
            { name: 'Reporte de Pagos', date: '2026-04-25', type: 'PDF' },
            { name: 'Proyección Trimestral', date: '2026-04-20', type: 'PDF' }
          ].map((report, index) => (
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-3">
          {[
            { name: 'Asistencia de Clases', date: '2026-04-30', type: 'Excel' },
            { name: 'Rendimiento de Entrenadores', date: '2026-04-29', type: 'PDF' },
            { name: 'Ocupación de Instalaciones', date: '2026-04-28', type: 'PDF' },
            { name: 'Análisis de Horarios Pico', date: '2026-04-27', type: 'Excel' }
          ].map((report, index) => (
            <div key={index} className="flex items-center justify-between p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
              <div className="flex items-center gap-3">
