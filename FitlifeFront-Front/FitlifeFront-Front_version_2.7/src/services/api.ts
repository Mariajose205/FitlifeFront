...
// Base URLs para los microservicios - Conexión directa (temporal)
const BASE_URLS = {
  pagos: 'http://localhost:8086/api/pagos',
  ...
  usuarios: 'http://localhost:8085/api/usuarios' // Conexión directa a MS-usuarios
};
