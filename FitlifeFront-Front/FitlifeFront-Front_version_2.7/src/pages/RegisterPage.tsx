...
export const RegisterPage: React.FC = () => {
  ...
  useEffect(() => {
    localStorage.setItem('fitlife_registration_draft', JSON.stringify(formData));
  }, [formData]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'ERR_NETWORK' || error.code === 'ECONNREFUSED') {
        setError('No se puede conectar al servidor de usuarios. Por favor, verifica que MS-usuarios esté corriendo en el puerto 8085.');
      } else if (error.response?.status === 400) {
        setError('Datos inválidos. Por favor, verifica todos los campos y las validaciones.');
      } else if (error.response?.status === 409) {
        setError('Este correo electrónico ya está registrado. Por favor, inicia sesión.');
      } else {
        const errorMessage = error.response?.data?.message || error.response?.data?.error || 'Error al registrar usuario. Por favor, inténtalo de nuevo.';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`input-field pl-10 ${errors.firstName ? 'border-red-500 focus:border-red-500' : ''}`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`input-field ${errors.lastName ? 'border-red-500 focus:border-red-500' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`input-field pl-10 ${errors.birthDate ? 'border-red-500 focus:border-red-500' : ''}`}
                />
                {errors.birthDate && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`input-field pl-10 ${errors.address ? 'border-red-500 focus:border-red-500' : ''}`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Crea una contraseña (mínimo 7 caracteres)"
                  />
                  {errors.password && (
