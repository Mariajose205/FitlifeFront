...
export const AdminPage: React.FC = () => {
  ...
  const recentActivities = [
    { id: 1, user: 'María González', action: 'Registró nueva cuenta', time: '2024-01-15 14:30', type: 'user' },
    { id: 2, user: 'Juan Entrenador', action: 'Creó clase nueva', time: '2024-01-15 13:15', type: 'trainer' },
    { id: 3, user: 'Carlos Rodríguez', action: 'Actualizó membresía', time: '2024-01-15 12:45', type: 'user' },
    { id: 4, user: 'Ana Martínez', action: 'Canceló clase', time: '2024-01-15 11:20', type: 'user' },
    { id: 5, user: 'Pedro Sánchez', action: 'Inició sesión', time: '2024-01-15 10:30', type: 'user' },
  ];
