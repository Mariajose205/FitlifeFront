...
import { isUserAuthenticated } from '../utils/userTypeDetection';
import { Search, Filter, Users, MapPin, Calendar, Clock, Plus, Minus, Trash2, ChevronRight, AlertCircle } from 'lucide-react';
...
export const ReservationsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (!isUserAuthenticated()) {
      ...
      localStorage.setItem('fitlife_redirect_after_login', '/reservas');
      navigate('/login');
      return;
    }
  }, [navigate]);
  ...
  const classes: Class[] = [
    ...
    },
    {
      ...
      duration: '60 min',
      price: 16000,
      image: '/src/assets/imagenes/yoga.png',
      level: 'beginner',
      enrolled: 18,
      maxSpots: 25,
      description: 'Clase de yoga para mejorar flexibilidad, equilibrio y reducir el estrés.'
    },
    {
      id: '6',
      name: 'CrossFit',
      ...
      duration: '50 min',
      price: 22000,
      image: '/src/assets/imagenes/crossfit.png',
      level: 'advanced',
      enrolled: 6,
      maxSpots: 15,
      description: 'Entrenamiento de alta intensidad con ejercicios funcionales variados.'
    },
    {
      id: '7',
      name: 'Zumba',
      ...
      duration: '55 min',
      price: 14000,
      image: '/src/assets/imagenes/zumba.png',
      level: 'intermediate',
      enrolled: 20,
      maxSpots: 30,
      description: 'Clase de baile fitness con ritmos latinos y movimientos energéticos.'
    },
    {
      id: '8',
      name: 'Natación',
      ...
      duration: '45 min',
      price: 18000,
      image: '/src/assets/imagenes/natacion.png',
      level: 'beginner',
      enrolled: 12,
      maxSpots: 20,
      description: 'Clase de natación para aprender técnicas básicas y mejorar resistencia.'
    }
  ];
