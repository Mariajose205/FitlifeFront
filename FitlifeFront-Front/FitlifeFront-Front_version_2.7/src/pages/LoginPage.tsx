...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const savedRedirect = localStorage.getItem('fitlife_redirect_after_login');
      if (savedRedirect) {
        // Clear the saved redirect
        localStorage.removeItem('fitlife_redirect_after_login');
        navigate(savedRedirect);
      } else {
        // Use default redirect based on user role
