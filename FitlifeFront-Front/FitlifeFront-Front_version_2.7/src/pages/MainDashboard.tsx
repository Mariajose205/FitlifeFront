...
export const MainDashboard: React.FC = () => {
  ...
  const classes = [
    ...
    { id: '3', name: 'Boxing', trainer: 'Pedro Sánchez', gym: 'FitLife Providencia', date: '2024-01-16', time: '07:00 PM', duration: '50 min', spots: 12, maxSpots: 15, level: 'Avanzado', image: boxeoImage },
    ...
    { id: '5', name: 'Pilates Reformer', trainer: 'Laura Silva', gym: 'FitLife La Florida', date: '2024-01-17', time: '09:00 AM', duration: '55 min', spots: 10, maxSpots: 12, level: 'Principiante', image: pilatesImage },
