            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white p-4 rounded-lg border border-secondary-200">
                  ...
                  <div className="text-sm text-secondary-600">Este mes</div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-secondary-200">
                  <div className="text-sm text-secondary-500 mb-2">Clases Completadas</div>
                  <div className="text-2xl font-bold text-green-600">8</div>
                  <div className="text-sm text-secondary-600">Este mes</div>
                </div>
                <div className="bg-white p-4 rounded-lg border border-secondary-200">
                  <div className="text-sm text-secondary-500 mb-2">Próxima Clase</div>
                  <div className="text-lg font-semibold text-blue-600">Spinning</div>
                  <div className="text-sm text-secondary-600">Hoy, 18:00</div>
                </div>
              </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-secondary-900">Spinning Intensivo</div>
                            <div className="text-sm text-secondary-600">
                              <div className="flex items-center space-x-2">
                                <MapPin className="w-3 h-3" />
                                <span>FitLife Vitacura</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <Calendar className="w-3 h-3" />
                                <span>05/05/2024, 18:00</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          <div className="w-2 h-2 rounded-full bg-green-500"></div>
                          <div>
                            <div className="font-medium text-secondary-900">Entrenamiento Funcional</div>
                            <div className="text-sm text-secondary-600">
                              <div className="flex items-center space-x-2">
                                <MapPin className="w-3 h-3" />
                                <span>FitLife Las Condes</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <Calendar className="w-3 h-3" />
                                <span>03/05/2024, 07:00</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-secondary-900">Yoga</div>
                            <div className="text-sm text-secondary-600">
                              <div className="flex items-center space-x-2">
                                <MapPin className="w-3 h-3" />
                                <span>FitLife Providencia</span>
                              </div>
                              <div className="flex items-center space-x-2">
                                <Calendar className="w-3 h-3" />
                                <span>04/05/2024, 09:00</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <div className="font-medium text-secondary-900">Boxing</div>
                            <div className="text-sm text-secondary-600">
                              <div className="flex items-center space-x-2">
                                <MapPin className="w-3 h-3" />
                                <span>FitLife Vitacura</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-green-800">Total Pagado este Mes</span>
                    </div>
                    <div className="text-2xl font-bold text-green-600">$45,000</div>
                    <div className="text-sm text-green-600">3 reservas completadas</div>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <div className="text-lg font-semibold text-blue-600">$15,000</div>
                    <div className="text-sm text-blue-600">Spinning • 02/05/2024</div>
                  </div>
                </div>
              </div>
            </div>
